...
for n=1:numel(MR.Data);MR.Parameter.Gridder.OutputMatrixSize{n}=[round(MR.Parameter.Encoding.XRes(n).*MR.Parameter.Encoding.KxOversampling(n)) round(MR.Parameter.Encoding.YRes(n).*MR.Parameter.Encoding.KyOversampling(n))];end

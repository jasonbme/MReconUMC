...
if (strcmpi(MR.UMCParameters.LinearReconstruction.LoadCoilSensitivityMaps,'yes') && exist('csm.mat')==2)
...
switch MR.UMCParameters.LinearReconstruction.CoilSensitivityMaps
    case 'espirit'
        % Notification
    ...
    case 'openadapt'
        ...
        store={MR.Data,MR.Parameter.Encoding.NrDyn,MR.UMCParameters.LinearReconstruction.NUFFTMethod,...
            MR.Parameter.Recon.CoilCombination,MR.Parameter.Gridder.Weights...
            ,MR.Parameter.Gridder.Kpos,MR.UMCParameters.LinearReconstruction.IspaceSize,MR.Parameter.Scan.Samples};
        ...
        if ~strcmpi(MR.UMCParameters.LinearReconstruction.NUFFTMethod,'mrecon');MR.Parameter.Gridder.Weights=...
                permute(reshape(permute(MR.Parameter.Gridder.Weights,[1 2 5 3 4]),[ns nl*ndyn 1 1 1]),[1 2 4 3 5]);end
        if ~strcmpi(MR.UMCParameters.LinearReconstruction.NUFFTMethod,'mrecon');MR.Parameter.Gridder.Kpos=...
                permute(reshape(permute(MR.Parameter.Gridder.Kpos,[1 2 5 3 4]),[ns nl*ndyn 1 1 1]),[1 2 4 3 5]);end
        if strcmpi(MR.UMCParameters.LinearReconstruction.NUFFTMethod,'mrecon');MR.Parameter.Scan.Samples=[ns nl nz];end
        ...
        [MR.Data,MR.Parameter.Encoding.NrDyn,MR.UMCParameters.LinearReconstruction.NUFFTMethod,...
            MR.Parameter.Recon.CoilCombination,MR.Parameter.Gridder.Weights...
            ,MR.Parameter.Gridder.Kpos,MR.UMCParameters.LinearReconstruction.IspaceSize,MR.Parameter.Scan.Samples]=store{:};
        MR=SetGriddingFlags(MR,0);

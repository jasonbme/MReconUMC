...
%if MR.Parameter.IsParameter('UGN1_TOM_mrf')==1;MR.UMCParameters.LinearReconstruction.MRF=MR.Parameter.GetValue('`UGN1_TOM_mrf');end
%if MR.Parameter.IsParameter('UGN1_TOM_mrf')==1;if strcmpi(MR.UMCParameters.LinearReconstruction.MRF,'YES');MR.UMCParameters.RadialDataCorrection.PhaseCorrection='fit';end;end
...
MR.UMCParameters.RadialDataCorrection.NumberOfCalibrationSpokes=0;
MR.Parameter.Encoding.NrDyn=5;

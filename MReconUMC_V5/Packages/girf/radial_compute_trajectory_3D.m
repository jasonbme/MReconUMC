...
k_accumulated=gamma*cumsum(MR.UMCParameters.SystemCorrections.GIRF_output_waveforms*(MR.UMCParameters.SystemCorrections.GIRF_time(2)-MR.UMCParameters.SystemCorrections.GIRF_time(1))); 
k_accumulated_nom=gamma*cumsum(MR.UMCParameters.SystemCorrections.GIRF_input_waveforms*(MR.UMCParameters.SystemCorrections.GIRF_time(2)-MR.UMCParameters.SystemCorrections.GIRF_time(1)));
...
if strcmpi(MR.Parameter.Scan.KooshBall,'no')
    ...
    for nl=1:Kd{n}(2)
        Kpos{n}(:,:,nl,z,1,dyn,ph,ech,loc,mix,ex1,ex2)=...
            [interp1qr(MR.UMCParameters.SystemCorrections.GIRF_time,k_real(MR.Parameter.Gridder.RadialAngles{n}(:,nl,1,1,dyn,ph,ech,loc,mix,ex1,ex2),k_accumulated(:,1)),MR.UMCParameters.SystemCorrections.GIRF_ADC_time{n}(:,ech)) ...
            interp1qr(MR.UMCParameters.SystemCorrections.GIRF_time,k_imag(MR.Parameter.Gridder.RadialAngles{n}(:,nl,1,1,dyn,ph,ech,loc,mix,ex1,ex2),k_accumulated(:,2)),MR.UMCParameters.SystemCorrections.GIRF_ADC_time{n}(:,ech)) ...
            -1*interp1qr(MR.UMCParameters.SystemCorrections.GIRF_time,((z-ceil(Kd{n}(3)/2))/floor(Kd{n}(3)/2))*k_accumulated(:,3),MR.UMCParameters.SystemCorrections.GIRF_ADC_time{n}(:,ech))];
        
        Kpos_nom{n}(:,:,nl,z,1,dyn,ph,ech,loc,mix,ex1,ex2)=...
            [interp1qr(MR.UMCParameters.SystemCorrections.GIRF_time,k_real(MR.Parameter.Gridder.RadialAngles{n}(:,nl,1,1,dyn,ph,ech,loc,mix,ex1,ex2),k_accumulated_nom(:,1)),MR.UMCParameters.SystemCorrections.GIRF_ADC_time{n}(:,ech)) ...
            interp1qr(MR.UMCParameters.SystemCorrections.GIRF_time,k_imag(MR.Parameter.Gridder.RadialAngles{n}(:,nl,1,1,dyn,ph,ech,loc,mix,ex1,ex2),k_accumulated_nom(:,2)),MR.UMCParameters.SystemCorrections.GIRF_ADC_time{n}(:,ech)) ...
            -1*interp1qr(MR.UMCParameters.SystemCorrections.GIRF_time,((z-ceil(Kd{n}(3)/2))/floor(Kd{n}(3)/2))*k_accumulated_nom(:,3),MR.UMCParameters.SystemCorrections.GIRF_ADC_time{n}(:,ech))];
    end
    end % Z
    end % Dynamics
    end % Echos

...
if ~strcmpi(MR.UMCParameters.RadialDataCorrection.PhaseCorrection,'none')

    % Notification
    fprintf('Applying phase correction ........................  ');tic

    if strcmpi(MR.UMCParameters.RadialDataCorrection.PhaseCorrection,'fit')
    ...
    if strcmpi(MR.UMCParameters.RadialDataCorrection.PhaseCorrection,'zero')
        [ns,~]=size(MR.Data);
        cp=ns/2+1; % k0 index

...
% 20160616 - Jeff Fesslers nufft_toolbox package.
...
% combination function as well, unlike gaussian gridding.
...
% Get own trajectory
MR.Parameter.Gridder.Kpos=RadialTrajectory(MR)*MR.Parameter.Gridder.GridOvsFactor*(1/MR.ParUMC.ReconRatio);
...
param.E=MCNUFFT(MR.Parameter.Gridder.Kpos,MR.Parameter.Gridder.Weights,MR.Parameter.Recon.Sensitivities); 

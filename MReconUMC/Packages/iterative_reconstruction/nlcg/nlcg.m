...
% Verbose
if params.Verbose;
    figure(211);close(211);hfig=figure(211);subplot(221);
...
% objective function
res=L2obj+TVobj+params.WaveletLambda*Wobj; % TV lambda is already in the matrix T

L1_Wavelet=params.WaveletLambda*Wobj;
L1_TV=TVobj;
...
% composite gradient
g=L2Grad+TVGrad+params.WaveletLambda*WGrad;

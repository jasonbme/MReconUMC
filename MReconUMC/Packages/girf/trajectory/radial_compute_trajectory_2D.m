...
for z=1:Kd{n}(3)    % Z
    for nl=1:Kd{n}(2)
        Kpos{n}(:,:,nl,z,1,dyn,ph,ech,loc,mix,ex1,ex2)=...
            [interp1qr(MR.UMCParameters.SystemCorrections.GirfTime,k_real(MR.Parameter.Gridder.RadialAngles{n}(:,nl,z,1,dyn,ph,ech,loc,mix,ex1,ex2),k_accumulated(:,1)),MR.UMCParameters.SystemCorrections.GirfADCTime{n}(:,ech)) ...
            interp1qr(MR.UMCParameters.SystemCorrections.GirfTime,k_imag(MR.Parameter.Gridder.RadialAngles{n}(:,nl,z,1,dyn,ph,ech,loc,mix,ex1,ex2),k_accumulated(:,2)),MR.UMCParameters.SystemCorrections.GirfADCTime{n}(:,ech)) ...
            zeros(numel(MR.UMCParameters.SystemCorrections.GirfADCTime{n}(:,ech)),1)];
        
        Kpos_nom{n}(:,:,nl,z,1,dyn,ph,ech,loc,mix,ex1,ex2)=...
            [interp1qr(MR.UMCParameters.SystemCorrections.GirfTime,k_real(MR.Parameter.Gridder.RadialAngles{n}(:,nl,z,1,dyn,ph,ech,loc,mix,ex1,ex2),k_accumulated_nom(:,1)),MR.UMCParameters.SystemCorrections.GirfADCTime{n}(:,ech)) ...
            interp1qr(MR.UMCParameters.SystemCorrections.GirfTime,k_imag(MR.Parameter.Gridder.RadialAngles{n}(:,nl,z,1,dyn,ph,ech,loc,mix,ex1,ex2),k_accumulated_nom(:,2)),MR.UMCParameters.SystemCorrections.GirfADCTime{n}(:,ech)) ...
            zeros(numel(MR.UMCParameters.SystemCorrections.GirfADCTime{n}(:,ech)),1)];
    end
end % Z
end % Dynamics
